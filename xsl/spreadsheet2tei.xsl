                                ...
                                <!-- Is there any additional way we should mark anonymous writers, other than in the format of the name? -->
                                    <person xml:id="{$person-id}">
                                        ...
                                        <xsl:if test="starts-with(Necessary_Corrections,'Deprecation: ')">
                                            ...
                                            <!-- need to compute the list of unique names in order to calculate the xml:id attributes for deprecated names -->
                                            <!-- this code was taken from names.xsl lines 73-85 -->
